...
public class InputParameters {
    ...
    public SynchronizedList<Sketch[]> pairsOfSketches;
    ...
    public void parseInput(String[] args){
        ...
        if (this.type.equals("dist"))
            input = new Option("i", "input", true, "input file path (either *.ske file or all fasta files in directory)");
            ...
            input = new Option("i", "input", true, "*.ske file of interest");
    ...
    private void update(CommandLine cmd) {
        ...
        if (input.endsWith(".ske")&&(this.type.equals("dist")||this.type.equals("info"))){
            this.sketches = (Sketch[])WriteReadObject.readObjectFromFile(input);
        ...
        if (this.sketches==null&&this.type.equals("info")){
            System.out.println("To get information on a sketch, you need to input a valid *.ske file");
            System.exit(1);
        }
